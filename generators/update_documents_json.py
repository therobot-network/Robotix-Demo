...
def update_documents_json():
    ...
    survey_types = [
        ("product-satisfaction-survey", "Product Satisfaction Survey", "Customer survey about product quality and satisfaction"),
        ("customer-service-experience-survey", "Customer Service Experience Survey", "Survey about customer service interactions and support quality"),
        ("post-purchase-feedback-form", "Post-Purchase Feedback Form", "Feedback form for customers after product delivery")
    ]
